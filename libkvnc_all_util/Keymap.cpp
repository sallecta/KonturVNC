...
#include "winhdr.h"
#include "../libkvnc_all_winSystem/InputInjector.h"
#include "../libkvnc_all_winSystem/Keyboard.h"
#include <crtdbg.h>

#define lkvnc_rfb_DefsKeySym_MISCELLANY
#define lkvnc_rfb_DefsKeySym_CYRILLIC

#include "../libkvnc_all_rfb/lkvnc_rfb_DefsKeySym.h"
...
const KS2VKEntry SERVER_AUXILIARY_TRANSLATE_TABLE[] = {
  { lkvnc_rfb_DefsKeySym_Shift_L,   VK_LSHIFT },
  { lkvnc_rfb_DefsKeySym_Shift_R,   VK_RSHIFT },
  { lkvnc_rfb_DefsKeySym_Shift_L,   VK_SHIFT },
  { lkvnc_rfb_DefsKeySym_Control_L, VK_LCONTROL },
  { lkvnc_rfb_DefsKeySym_Control_R, VK_RCONTROL },
  { lkvnc_rfb_DefsKeySym_Control_L, VK_CONTROL },
  { lkvnc_rfb_DefsKeySym_Alt_L,     VK_LMENU },
  { lkvnc_rfb_DefsKeySym_Alt_R,     VK_RMENU },
  { lkvnc_rfb_DefsKeySym_Alt_L,     VK_MENU },
  { lkvnc_rfb_DefsKeySym_Left,      VK_LEFT},
  { lkvnc_rfb_DefsKeySym_Up,        VK_UP},
  { lkvnc_rfb_DefsKeySym_Right,     VK_RIGHT},
  { lkvnc_rfb_DefsKeySym_Down,      VK_DOWN},
  { lkvnc_rfb_DefsKeySym_Tab,       VK_TAB },
  { lkvnc_rfb_DefsKeySym_BackSpace, VK_BACK },
  { lkvnc_rfb_DefsKeySym_Return,    VK_RETURN },
  { lkvnc_rfb_DefsKeySym_Execute,   VK_EXECUTE },
  { lkvnc_rfb_DefsKeySym_Pause,     VK_PAUSE },
  { lkvnc_rfb_DefsKeySym_Escape,    VK_ESCAPE },
  { lkvnc_rfb_DefsKeySym_Clear,     VK_CLEAR },
  { lkvnc_rfb_DefsKeySym_Delete,    VK_DELETE },
  { lkvnc_rfb_DefsKeySym_Home,      VK_HOME },
  { lkvnc_rfb_DefsKeySym_Page_Up,   VK_PRIOR },
  { lkvnc_rfb_DefsKeySym_Page_Down, VK_NEXT },
  { lkvnc_rfb_DefsKeySym_End,       VK_END },
  { lkvnc_rfb_DefsKeySym_Select,    VK_SELECT },
  { lkvnc_rfb_DefsKeySym_Print,     VK_SNAPSHOT },
  { lkvnc_rfb_DefsKeySym_Insert,    VK_INSERT },
  { lkvnc_rfb_DefsKeySym_Help,      VK_HELP },
  { lkvnc_rfb_DefsKeySym_Break,     VK_CANCEL },

  { lkvnc_rfb_DefsKeySym_KP_Space,     VK_SPACE },
  { lkvnc_rfb_DefsKeySym_KP_Tab,       VK_TAB },
  { lkvnc_rfb_DefsKeySym_KP_Enter,     VK_RETURN },
  { lkvnc_rfb_DefsKeySym_KP_F1,        VK_F1 },
  { lkvnc_rfb_DefsKeySym_KP_F2,        VK_F2 },
  { lkvnc_rfb_DefsKeySym_KP_F3,        VK_F3 },
  { lkvnc_rfb_DefsKeySym_KP_F4,        VK_F4 },
  { lkvnc_rfb_DefsKeySym_KP_Home,      VK_HOME },
  { lkvnc_rfb_DefsKeySym_KP_Left,      VK_LEFT },
  { lkvnc_rfb_DefsKeySym_KP_Up,        VK_UP },
  { lkvnc_rfb_DefsKeySym_KP_Right,     VK_RIGHT },
  { lkvnc_rfb_DefsKeySym_KP_Down,      VK_DOWN },
  { lkvnc_rfb_DefsKeySym_KP_Page_Up,   VK_PRIOR },
  { lkvnc_rfb_DefsKeySym_KP_Page_Down, VK_NEXT },
  { lkvnc_rfb_DefsKeySym_KP_End,       VK_END },
  { lkvnc_rfb_DefsKeySym_KP_Begin,     VK_CLEAR },
  { lkvnc_rfb_DefsKeySym_KP_Insert,    VK_INSERT },
  { lkvnc_rfb_DefsKeySym_KP_Delete,    VK_DELETE },
  { lkvnc_rfb_DefsKeySym_KP_Equal,     0xbb }, // FIXME: What is it?
  { lkvnc_rfb_DefsKeySym_KP_Multiply,  VK_MULTIPLY },
  { lkvnc_rfb_DefsKeySym_KP_Add,       VK_ADD },
  { lkvnc_rfb_DefsKeySym_KP_Separator, VK_SEPARATOR },
  { lkvnc_rfb_DefsKeySym_KP_Subtract,  VK_SUBTRACT },
  { lkvnc_rfb_DefsKeySym_KP_Decimal,   VK_DECIMAL },
  { lkvnc_rfb_DefsKeySym_KP_Divide,    VK_DIVIDE },

  { lkvnc_rfb_DefsKeySym_KP_0,         VK_NUMPAD0 },
  { lkvnc_rfb_DefsKeySym_KP_1,         VK_NUMPAD1 },
  { lkvnc_rfb_DefsKeySym_KP_2,         VK_NUMPAD2 },
  { lkvnc_rfb_DefsKeySym_KP_3,         VK_NUMPAD3 },
  { lkvnc_rfb_DefsKeySym_KP_4,         VK_NUMPAD4 },
  { lkvnc_rfb_DefsKeySym_KP_5,         VK_NUMPAD5 },
  { lkvnc_rfb_DefsKeySym_KP_6,         VK_NUMPAD6 },
  { lkvnc_rfb_DefsKeySym_KP_7,         VK_NUMPAD7 },
  { lkvnc_rfb_DefsKeySym_KP_8,         VK_NUMPAD8 },
  { lkvnc_rfb_DefsKeySym_KP_9,         VK_NUMPAD9 },

  { lkvnc_rfb_DefsKeySym_F1, VK_F1 },
  { lkvnc_rfb_DefsKeySym_F2, VK_F2 },
  { lkvnc_rfb_DefsKeySym_F3, VK_F3 },
  { lkvnc_rfb_DefsKeySym_F4, VK_F4 },
  { lkvnc_rfb_DefsKeySym_F5, VK_F5 },
  { lkvnc_rfb_DefsKeySym_F6, VK_F6 },
  { lkvnc_rfb_DefsKeySym_F7, VK_F7 },
  { lkvnc_rfb_DefsKeySym_F8, VK_F8 },
  { lkvnc_rfb_DefsKeySym_F9, VK_F9 },
  { lkvnc_rfb_DefsKeySym_F10, VK_F10 },
  { lkvnc_rfb_DefsKeySym_F11, VK_F11 },
  { lkvnc_rfb_DefsKeySym_F12, VK_F12 },
  { lkvnc_rfb_DefsKeySym_F13, VK_F13 },
  { lkvnc_rfb_DefsKeySym_F14, VK_F14 },
  { lkvnc_rfb_DefsKeySym_F15, VK_F15 },
  { lkvnc_rfb_DefsKeySym_F16, VK_F16 },
  { lkvnc_rfb_DefsKeySym_F17, VK_F17 },
  { lkvnc_rfb_DefsKeySym_F18, VK_F18 },
  { lkvnc_rfb_DefsKeySym_F19, VK_F19 },
  { lkvnc_rfb_DefsKeySym_F20, VK_F20 },
  { lkvnc_rfb_DefsKeySym_F21, VK_F21 },
  { lkvnc_rfb_DefsKeySym_F22, VK_F22 },
  { lkvnc_rfb_DefsKeySym_F23, VK_F23 },
  { lkvnc_rfb_DefsKeySym_F24, VK_F24 },
  { lkvnc_rfb_DefsKeySym_Super_L, VK_LWIN },
  { lkvnc_rfb_DefsKeySym_Super_R, VK_RWIN },
  { lkvnc_rfb_DefsKeySym_Menu, VK_APPS }
};

const VK2KSEntry VIEWER_AUXILIARY_TRANSLATE_TABLE[] = {
  { VK_LSHIFT,    lkvnc_rfb_DefsKeySym_Shift_L },
  { VK_RSHIFT,    lkvnc_rfb_DefsKeySym_Shift_R },
  { VK_SHIFT,     lkvnc_rfb_DefsKeySym_Shift_L },
  { VK_LCONTROL,  lkvnc_rfb_DefsKeySym_Control_L },
  { VK_RCONTROL,  lkvnc_rfb_DefsKeySym_Control_R },
  { VK_CONTROL,   lkvnc_rfb_DefsKeySym_Control_L },
  { VK_LMENU,     lkvnc_rfb_DefsKeySym_Alt_L },
  { VK_RMENU,     lkvnc_rfb_DefsKeySym_Alt_R },
  { VK_MENU,      lkvnc_rfb_DefsKeySym_Alt_L },
  { VK_LEFT,      lkvnc_rfb_DefsKeySym_Left},
  { VK_UP,        lkvnc_rfb_DefsKeySym_Up},
  { VK_RIGHT,     lkvnc_rfb_DefsKeySym_Right},
  { VK_DOWN,      lkvnc_rfb_DefsKeySym_Down},
  { VK_TAB,       lkvnc_rfb_DefsKeySym_Tab },
  { VK_BACK,      lkvnc_rfb_DefsKeySym_BackSpace },
  { VK_RETURN,    lkvnc_rfb_DefsKeySym_Return },
  { VK_EXECUTE,   lkvnc_rfb_DefsKeySym_Execute },
  { VK_PAUSE,     lkvnc_rfb_DefsKeySym_Pause },
  { VK_ESCAPE,    lkvnc_rfb_DefsKeySym_Escape },
  { VK_CLEAR,     lkvnc_rfb_DefsKeySym_Clear },
  { VK_DELETE,    lkvnc_rfb_DefsKeySym_Delete },
  { VK_HOME,      lkvnc_rfb_DefsKeySym_Home },
  { VK_PRIOR,     lkvnc_rfb_DefsKeySym_Page_Up },
  { VK_NEXT,      lkvnc_rfb_DefsKeySym_Page_Down },
  { VK_END,       lkvnc_rfb_DefsKeySym_End },
  { VK_SELECT,    lkvnc_rfb_DefsKeySym_Select },
  { VK_SNAPSHOT,  lkvnc_rfb_DefsKeySym_Print },
  { VK_INSERT,    lkvnc_rfb_DefsKeySym_Insert },
  { VK_HELP,      lkvnc_rfb_DefsKeySym_Help },
  { VK_CANCEL,    lkvnc_rfb_DefsKeySym_Break },

  { VK_MULTIPLY,  lkvnc_rfb_DefsKeySym_KP_Multiply },
  { VK_ADD,       lkvnc_rfb_DefsKeySym_KP_Add },
  { VK_SEPARATOR, lkvnc_rfb_DefsKeySym_KP_Separator },
  { VK_SUBTRACT,  lkvnc_rfb_DefsKeySym_KP_Subtract },
  { VK_DECIMAL,   lkvnc_rfb_DefsKeySym_KP_Decimal },
  { VK_DIVIDE,    lkvnc_rfb_DefsKeySym_KP_Divide },

  { VK_NUMPAD0,   lkvnc_rfb_DefsKeySym_KP_0 },
  { VK_NUMPAD1,   lkvnc_rfb_DefsKeySym_KP_1 },
  { VK_NUMPAD2,   lkvnc_rfb_DefsKeySym_KP_2 },
  { VK_NUMPAD3,   lkvnc_rfb_DefsKeySym_KP_3 },
  { VK_NUMPAD4,   lkvnc_rfb_DefsKeySym_KP_4 },
  { VK_NUMPAD5,   lkvnc_rfb_DefsKeySym_KP_5 },
  { VK_NUMPAD6,   lkvnc_rfb_DefsKeySym_KP_6 },
  { VK_NUMPAD7,   lkvnc_rfb_DefsKeySym_KP_7 },
  { VK_NUMPAD8,   lkvnc_rfb_DefsKeySym_KP_8 },
  { VK_NUMPAD9,   lkvnc_rfb_DefsKeySym_KP_9 },

  { VK_F1,        lkvnc_rfb_DefsKeySym_F1 },
  { VK_F2,        lkvnc_rfb_DefsKeySym_F2 },
  { VK_F3,        lkvnc_rfb_DefsKeySym_F3 },
  { VK_F4,        lkvnc_rfb_DefsKeySym_F4 },
  { VK_F5,        lkvnc_rfb_DefsKeySym_F5 },
  { VK_F6,        lkvnc_rfb_DefsKeySym_F6 },
  { VK_F7,        lkvnc_rfb_DefsKeySym_F7 },
  { VK_F8,        lkvnc_rfb_DefsKeySym_F8 },
  { VK_F9,        lkvnc_rfb_DefsKeySym_F9 },
  { VK_F10,       lkvnc_rfb_DefsKeySym_F10 },
  { VK_F11,       lkvnc_rfb_DefsKeySym_F11 },
  { VK_F12,       lkvnc_rfb_DefsKeySym_F12 },
  { VK_F13,       lkvnc_rfb_DefsKeySym_F13 },
  { VK_F14,       lkvnc_rfb_DefsKeySym_F14 },
  { VK_F15,       lkvnc_rfb_DefsKeySym_F15 },
  { VK_F16,       lkvnc_rfb_DefsKeySym_F16 },
  { VK_F17,       lkvnc_rfb_DefsKeySym_F17 },
  { VK_F18,       lkvnc_rfb_DefsKeySym_F18 },
  { VK_F19,       lkvnc_rfb_DefsKeySym_F19 },
  { VK_F20,       lkvnc_rfb_DefsKeySym_F20 },
  { VK_F21,       lkvnc_rfb_DefsKeySym_F21 },
  { VK_F22,       lkvnc_rfb_DefsKeySym_F22 },
  { VK_F23,       lkvnc_rfb_DefsKeySym_F23 },
  { VK_F24,       lkvnc_rfb_DefsKeySym_F24 },
  { VK_LWIN,      lkvnc_rfb_DefsKeySym_Super_L },
  { VK_RWIN,      lkvnc_rfb_DefsKeySym_Super_R },
  { VK_APPS,      lkvnc_rfb_DefsKeySym_Menu }
};
...
const UINT32 EXTENDED_KEYS[] = {
  lkvnc_rfb_DefsKeySym_Control_R,
  lkvnc_rfb_DefsKeySym_Alt_R,

  lkvnc_rfb_DefsKeySym_KP_Enter,
  lkvnc_rfb_DefsKeySym_KP_Divide,

  lkvnc_rfb_DefsKeySym_Home,
  lkvnc_rfb_DefsKeySym_Page_Up,
  lkvnc_rfb_DefsKeySym_Page_Down,
  lkvnc_rfb_DefsKeySym_End,
  lkvnc_rfb_DefsKeySym_Insert,
  lkvnc_rfb_DefsKeySym_Delete,

  lkvnc_rfb_DefsKeySym_Left,
  lkvnc_rfb_DefsKeySym_Up,
  lkvnc_rfb_DefsKeySym_Right,
  lkvnc_rfb_DefsKeySym_Down
};

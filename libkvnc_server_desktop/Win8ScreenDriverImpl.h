...
public:
  ...
  virtual lkvnc_rfb_FrameBuffer *getScreenBuffer();

  // Updates destination (*dst) cursor shape properties and data.
  void updateCursorShape(lkvnc_rfb_CursorShape *dst);
...
private:
  ...
  // This function always return the DX DXGI_FORMAT_B8G8R8A8_UNORM format in the lkvnc_rfb_PixelFormat type.
  lkvnc_rfb_PixelFormat getDxPixelFormat() const;

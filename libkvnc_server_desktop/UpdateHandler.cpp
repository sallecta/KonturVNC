...
void UpdateHandler::initFrameBuffer(const lkvnc_rfb_FrameBuffer *newFb)
{
  AutoLock al(&m_fbLocMut);
  m_backupFrameBuffer.clone(newFb);
}

bool UpdateHandler::updateExternalFrameBuffer(lkvnc_rfb_FrameBuffer *fb, const Region *region,
                                              const Rect *viewPort)
{
  AutoLock al(&m_fbLocMut);
...
bool UpdateHandler::updateExternalFrameBuffer(lkvnc_rfb_FrameBuffer *dstFb, lkvnc_rfb_FrameBuffer *srcFb,
                                              const Region *region,
                                              const Rect *viewPort)
{

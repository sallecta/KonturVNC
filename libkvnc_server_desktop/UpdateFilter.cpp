...
UpdateFilter::UpdateFilter(ScreenDriver *screenDriver,
                           ...
                           LocalMutex *lkvnc_rfb_FrameBufferCriticalSection,
                           LogWriter *log)
: m_screenDriver(screenDriver),
  m_frameBuffer(lkvnc_rfb_FrameBuffer),
  m_fbMutex(lkvnc_rfb_FrameBufferCriticalSection),
...
void UpdateFilter::filter(UpdateContainer *updateContainer)
{
  ...
  lkvnc_rfb_FrameBuffer *screenFrameBuffer = m_screenDriver->getScreenBuffer();

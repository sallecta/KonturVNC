...
void WinCursorShapeUtils::winMonoShapeToRfb(const lkvnc_rfb_FrameBuffer *pixels,
...
void WinCursorShapeUtils::fixAlphaChannel(const lkvnc_rfb_FrameBuffer *pixels,
...
UINT32 WinCursorShapeUtils::getAlphaMask(const lkvnc_rfb_PixelFormat *pf)
{
  if (pf->bitsPerPixel == 32) {

...
void WinDxgiOutputDuplication::getFrameCursorShape(lkvnc_rfb_CursorShape *argCursorShape,
                                                   UINT pointerShapeBufferSize)
{
  ...
  if (pointerShapeBufferSize != 0) {
    ...
    lkvnc_rfb_CursorShape newCursorShape;
    lkvnc_rfb_PixelFormat pf = lkvnc_rfb_PixelFormatCreator::create32bppPixelFormat();
    ...
    argCursorShape->clone(&newCursorShape);
  } else {
    argCursorShape->resetToEmpty();
  }
}

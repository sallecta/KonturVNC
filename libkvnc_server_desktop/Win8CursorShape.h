...
// This class is wrapper for lkvnc_rfb_CursorShape class to extend it behaviour for the Win8 desktop
// duplication model.
...
public:
  ...
  const lkvnc_rfb_CursorShape *getCursorShape() const;

  lkvnc_rfb_CursorShape *getCursorShapeForWriting();
...
private:
  ...
  bool m_isVisible;
  lkvnc_rfb_CursorShape m_emptyDimensionCursorShape;

...
void SasUserInput::setKeyboardEvent(UINT32 keySym, bool down)
{
  ...
  if (m_underVista) {
    switch (keySym) {
    case lkvnc_rfb_DefsKeySym_Alt_L:
    case lkvnc_rfb_DefsKeySym_Alt_R:
      m_altPressed = down;
      break;
    case lkvnc_rfb_DefsKeySym_Control_L:
    case lkvnc_rfb_DefsKeySym_Control_R:
      m_ctrlPressed = down;
      break;
    case lkvnc_rfb_DefsKeySym_Delete:
      delPressed = down;
    }
  }

...
lkvnc_rfb_CursorShapeDetector::lkvnc_rfb_CursorShapeDetector(UpdateKeeper *updateKeeper,
...
lkvnc_rfb_CursorShapeDetector::~lkvnc_rfb_CursorShapeDetector(void)
{
  terminate();
  wait();
}

void lkvnc_rfb_CursorShapeDetector::onTerminate()
{
  m_sleepTimer.notify();
}

void lkvnc_rfb_CursorShapeDetector::execute()
{

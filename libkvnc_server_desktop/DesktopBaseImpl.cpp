...
#include "../libkvnc_all_util/BrokenHandleException.h"
...
void DesktopBaseImpl::getFrameBufferProperties(Dimension *dim, lkvnc_rfb_PixelFormat *pf)
{
...
bool DesktopBaseImpl::updateExternalFrameBuffer(lkvnc_rfb_FrameBuffer *fb, const Region *region,
                                           const Rect *viewPort)
{

...
bool WindowsScreenGrabber::openDIBSection()
{
  ...
  lkvnc_rfb_PixelFormat lkvnc_rfb_PixelFormat = m_workFrameBuffer.getPixelFormat();
...
bool WindowsScreenGrabber::getPixelFormatChanged()
{
  ...
  lkvnc_rfb_PixelFormat currentPF = m_screen.getPixelFormat();
  lkvnc_rfb_PixelFormat lkvnc_rfb_FrameBufferPF = m_workFrameBuffer.getPixelFormat();

  return !lkvnc_rfb_FrameBufferPF.isEqualTo(&currentPF);
}
...
{
  m_screen.update();
  lkvnc_rfb_PixelFormat tmpPixelFormat = m_screen.getPixelFormat();

...
public:
  ...
  virtual bool grabCursorShape(const lkvnc_rfb_PixelFormat *pf);
  virtual const lkvnc_rfb_CursorShape *getCursorShape();
...
private:
  ...
  lkvnc_rfb_CursorShapeDetector m_curShapeDetector;

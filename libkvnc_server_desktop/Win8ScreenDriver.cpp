...
lkvnc_rfb_FrameBuffer *Win8ScreenDriver::getScreenBuffer()
{
...
bool Win8ScreenDriver::grabCursorShape(const lkvnc_rfb_PixelFormat *pf)
{
  m_drvImpl->updateCursorShape(&m_cursorShape);
  return !m_drvImpl->isValid();
}

const lkvnc_rfb_CursorShape *Win8ScreenDriver::getCursorShape()
{

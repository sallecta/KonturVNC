...
#include <cstring>
#include <stdlib.h>
#include "lkvnc_rfb_HostParser.h"

const size_t lkvnc_rfb_HostParser::m_SSH_USER_MAX_CHARS = 32;
const size_t lkvnc_rfb_HostParser::m_SSH_HOST_MAX_CHARS = 255;
const size_t lkvnc_rfb_HostParser::m_SSH_PORT_MAX_CHARS = 5;
const size_t lkvnc_rfb_HostParser::m_VNC_HOST_MAX_CHARS = 255;
const size_t lkvnc_rfb_HostParser::m_VNC_PORT_MAX_CHARS = 5;

lkvnc_rfb_HostParser::lkvnc_rfb_HostParser()
  : m_path(0),
    m_sshHost(0),
    m_sshPort(0),
    m_vncHost(0),
...
lkvnc_rfb_HostParser::lkvnc_rfb_HostParser(const char *path, int defaultPort)
  : m_path(0),
    m_sshHost(0),
    m_sshPort(0),
    m_vncHost(0),
...
bool
lkvnc_rfb_HostParser::set(const char *path)
{
...
void
lkvnc_rfb_HostParser::parsePath(size_t results[]) const
{
...
bool
lkvnc_rfb_HostParser::validateHostNames() const
{

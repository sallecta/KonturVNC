...
#include <atl/atlcore.h>        // for ATL Core
#include <atl/atlstr.h>         // for CAtlStringMgr
#include <atl/atlsimpstr.h>     // for CSimpleString
#include <atl/atlsimpcoll.h>    // for CSimpleArray

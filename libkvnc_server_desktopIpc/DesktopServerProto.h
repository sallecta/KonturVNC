...
protected:
  ...
  virtual void readPixelFormat(lkvnc_rfb_PixelFormat *pf,
                               BlockingGate *gate);
  virtual void sendPixelFormat(const lkvnc_rfb_PixelFormat *pf,
                               BlockingGate *gate);
  ...
  void sendFrameBuffer(const lkvnc_rfb_FrameBuffer *srcFb, const Rect *srcRect,
                       BlockingGate *gate);
  void readFrameBuffer(lkvnc_rfb_FrameBuffer *dstFb, const Rect *dstRect,
                       BlockingGate *gate);
...
private:
  void checkPixelFormat(const lkvnc_rfb_PixelFormat *pf);

...
void DesktopServerProto::checkPixelFormat(const lkvnc_rfb_PixelFormat *pf)
{
...
void DesktopServerProto::readPixelFormat(lkvnc_rfb_PixelFormat *pf,
                                         BlockingGate *gate)
{
...
void DesktopServerProto::sendPixelFormat(const lkvnc_rfb_PixelFormat *pf,
                                         BlockingGate *gate)
{
...
void DesktopServerProto::sendFrameBuffer(const lkvnc_rfb_FrameBuffer *srcFb,
                                         const Rect *srcRect,
                                         BlockingGate *gate)
{
  // FIXME: Additional lkvnc_rfb_FrameBuffer will be used temporarily.
  // This is easy way to send all pixels.
  lkvnc_rfb_PixelFormat pf = srcFb->getPixelFormat();
...
void DesktopServerProto::readFrameBuffer(lkvnc_rfb_FrameBuffer *dstFb,
                                         const Rect *dstRect,
                                         BlockingGate *gate)
{
  // FIXME: lkvnc_rfb_FrameBuffer will be used temporarily.
  // This is easy way to get all pixels.
  lkvnc_rfb_PixelFormat pf = dstFb->getPixelFormat();
  lkvnc_rfb_FrameBuffer fb;

...
#include "../libkvnc_all_fileTransfer/FileTransferException.h"
#include "../libkvnc_all_io/ByteArrayOutputStream.h"
#include "../libkvnc_all_file/File.h"
#include "../libkvnc_all_file/EOFException.h"
#include "../libkvnc_all_fileTransfer/FolderListener.h"
...
#include "../libkvnc_all_util/md5.h"
...
#include "../libkvnc_all_winSystem/Impersonator.h"
  ...
  m_log(log), m_ftsDialog(ftsDialog)
{
  ...
  registrator->addSrvToClCap(FTMessage::COMPRESSION_SUPPORT_REPLY, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::COMPRESSION_SUPPORT_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::FILE_LIST_REPLY, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::FILE_LIST_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::MD5_REPLY, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::MD5_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::UPLOAD_START_REPLY, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::UPLOAD_START_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::UPLOAD_DATA_REPLY, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::UPLOAD_DATA_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::UPLOAD_END_REPLY, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::UPLOAD_END_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::DOWNLOAD_START_REPLY, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::DOWNLOAD_START_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::DOWNLOAD_DATA_REPLY, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::DOWNLOAD_DATA_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::DOWNLOAD_END_REPLY, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::DOWNLOAD_END_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::MKDIR_REPLY, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::MKDIR_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::REMOVE_REPLY, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::REMOVE_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::RENAME_REPLY, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::RENAME_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::DIRSIZE_REPLY, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::DIRSIZE_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::LAST_REQUEST_FAILED_REPLY, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::LAST_REQUEST_FAILED_REPLY_SIG);

  registrator->addClToSrvCap(FTMessage::COMPRESSION_SUPPORT_REQUEST, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::COMPRESSION_SUPPORT_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::FILE_LIST_REQUEST, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::FILE_LIST_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::MD5_REQUEST, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::MD5_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::UPLOAD_START_REQUEST, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::UPLOAD_START_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::UPLOAD_DATA_REQUEST, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::UPLOAD_DATA_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::UPLOAD_END_REQUEST, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::UPLOAD_END_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::DOWNLOAD_START_REQUEST, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::DOWNLOAD_START_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::DOWNLOAD_DATA_REQUEST, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::DOWNLOAD_DATA_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::MKDIR_REQUEST, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::MKDIR_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::REMOVE_REQUEST, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::REMOVE_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::RENAME_REQUEST, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::RENAME_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::DIRSIZE_REQUEST, lkvnc_rfb_DefsVendor__Common::TIGHTVNC, FTMessage::DIRSIZE_REQUEST_SIG);

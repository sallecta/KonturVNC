...
public:
  ...
  // the DIB section.
  DibSection(const lkvnc_rfb_PixelFormat *pf, const Dimension *dim, HWND compatibleWin = 0);
  virtual ~DibSection();
...
private:
  ...
  void openDIBSection(const lkvnc_rfb_PixelFormat *pf, const Dimension *dim, HWND compatibleWin);
  ...
  void setupBMIStruct(BITMAPINFO *pBmi, const lkvnc_rfb_PixelFormat *pf, const Dimension *dim);

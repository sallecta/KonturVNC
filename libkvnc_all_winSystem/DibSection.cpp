...
DibSection::DibSection(const lkvnc_rfb_PixelFormat *pf, const Dimension *dim, HWND compatibleWin)
...
void DibSection::setupBMIStruct(BITMAPINFO *pBmi, const lkvnc_rfb_PixelFormat *pf, const Dimension *dim)
{
...
void DibSection::openDIBSection(const lkvnc_rfb_PixelFormat *pf, const Dimension *dim, HWND compatibleWin)
{

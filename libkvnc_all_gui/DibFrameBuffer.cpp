...
bool DibFrameBuffer::assignProperties(const lkvnc_rfb_FrameBuffer *srcFrameBuffer)
{
  throw Exception(_T("Wrong: You shouln't use the DibFrameBuffer::assignProperties() function."));
}

bool DibFrameBuffer::clone(const lkvnc_rfb_FrameBuffer *srcFrameBuffer)
{
...
bool DibFrameBuffer::isEqualTo(const lkvnc_rfb_FrameBuffer *lkvnc_rfb_FrameBuffer)
{
  return m_fb.isEqualTo(lkvnc_rfb_FrameBuffer);
}

bool DibFrameBuffer::copyFrom(const Rect *dstRect, const lkvnc_rfb_FrameBuffer *srcFrameBuffer,
                              int srcX, int srcY)
{
  return m_fb.copyFrom(dstRect, srcFrameBuffer, srcX, srcY);
}

bool DibFrameBuffer::copyFrom(const lkvnc_rfb_FrameBuffer *srcFrameBuffer, int srcX, int srcY)
{
  return m_fb.copyFrom(srcFrameBuffer, srcX, srcY);
}

bool DibFrameBuffer::overlay(const Rect *dstRect, const lkvnc_rfb_FrameBuffer *srcFrameBuffer,
...
bool DibFrameBuffer::cmpFrom(const Rect *dstRect, const lkvnc_rfb_FrameBuffer *srcFrameBuffer,
...
void DibFrameBuffer::setEmptyPixelFmt(const lkvnc_rfb_PixelFormat *pf)
{
  throw Exception(_T("This function is deprecated"));
}

void DibFrameBuffer::setPropertiesWithoutResize(const Dimension *newDim, const lkvnc_rfb_PixelFormat *pf)
{
...
bool DibFrameBuffer::setPixelFormat(const lkvnc_rfb_PixelFormat *lkvnc_rfb_PixelFormat)
{
  throw Exception(_T("Wrong: You shouln't use the DibFrameBuffer::setPixelFormat() function."));
}

inline lkvnc_rfb_PixelFormat DibFrameBuffer::getPixelFormat() const
{
  return m_fb.getPixelFormat();
}

bool DibFrameBuffer::setProperties(const Dimension *newDim, const lkvnc_rfb_PixelFormat *lkvnc_rfb_PixelFormat)
{
  throw Exception(_T("Wrong: You shouln't use this variant of the DibFrameBuffer::setProperties() function."));
}

bool DibFrameBuffer::setProperties(const Rect *dimByRect, const lkvnc_rfb_PixelFormat *lkvnc_rfb_PixelFormat)
{
  throw Exception(_T("Wrong: You shouln't use this variant of the DibFrameBuffer::setProperties() function."));
}
...
{
  m_fb.setPropertiesWithoutResize(newDim, lkvnc_rfb_PixelFormat);
  void *buffer = updateDibSection(newDim, lkvnc_rfb_PixelFormat, compatibleWindow);
  m_fb.setBuffer(buffer);
}

void *DibFrameBuffer::updateDibSection(const Dimension *argNewDim,
                                      const lkvnc_rfb_PixelFormat *argPixelFormat,
                                      HWND argCompatibleWindow)
{
  releaseDibSection();
  m_dibSection = new DibSection(argPixelFormat, argNewDim, argCompatibleWindow);
